...
setwd("D:\\babak\\Google drive\\_R\\Residents_SNA")
...
plot(g_peer_ps,
     vertex.color = V(g_peer_ps)$clr,
     vertex.size=(V(g_peer_ps)$w_degree),
...
plot(g_peer_ps,
     vertex.color = V(g_peer_ps)$clr,
     vertex.size=(V(g_peer_ps)$w_in)*2,
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
plot(g_peer_ps,
     vertex.color = V(g_peer_ps)$clr,
     vertex.size=(V(g_peer_ps)$w_out)*2,
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
plot(g_peer_fk,
     vertex.color = V(g_peer_fk)$clr,
     vertex.size=(V(g_peer_fk)$w_degree),
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
plot(g_peer_fk,
     vertex.color = V(g_peer_fk)$clr,
     vertex.size=(V(g_peer_fk)$w_in)*2,
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
plot(g_peer_fk,
     vertex.color = V(g_peer_fk)$clr,
     vertex.size=(V(g_peer_fk)$w_out)*2,
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
title(main = "Figure 2.6: Resident–Supervisor (Bipartite) Factual Knowledge Network - Nodes' size adjusted based on degree", cex.main = 0.9)
legend("bottomleft",
       c("Male", "Female"),
       pch = c(22, 21),           # 22 = filled square, 21 = filled circle
       col = "black",
...
title(main = "Figure 2.7: Resident–Supervisor (Bipartite) Factual Knowledge Network Nodes' size adjusted based on Strenght", cex.main = 0.9)
legend("bottomleft",
       c("Male", "Female"),
       pch = c(22, 21),           # 22 = filled square, 21 = filled circle
       col = "black",
...
plot(g_peer_p,
     vertex.color = V(g_peer_p)$clr,
     vertex.size=(V(g_peer_p)$w_degree),
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
plot(g_peer_p,
     vertex.color = V(g_peer_p)$clr,
     vertex.size=(V(g_peer_p)$w_out)*2,
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
title(main = "Figure 3.6: Resident–Supervisor (Bipartite) Network - Nodes' size adjusted based on degree", cex.main = 0.9)
legend("bottomleft",
       c("Male", "Female"),
       pch = c(22, 21),           # 22 = filled square, 21 = filled circle
       col = "black",
...
plot(
  g_bi_und_p, layout = L,
  vertex.shape = V(g_bi_und_p)$shape,
  vertex.size = 3+ V(g_bi_und_p)$strength * 0.5,
  vertex.label = V(g_bi_und_p)$name,
  vertex.label.cex = lab_cex,
  vertex.label.color = lab_col,
  edge.arrow.size = 0.5,
...
title(main = "Figure 3.7: Resident–Supervisor (Bipartite) Network Nodes' size adjusted based on Strenght", cex.main = 0.9)
legend("bottomleft",
       c("Male", "Female"),
       pch = c(22, 21),           # 22 = filled square, 21 = filled circle
       col = "black",
...
plot(g_peer_all,
     vertex.color = V(g_peer_all)$clr,
     vertex.size=(V(g_peer_all)$w_degree)* 0.7,
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
plot(g_peer_all,
     vertex.color = V(g_peer_all)$clr,
     vertex.size=(V(g_peer_all)$w_out),
     vertex.label.cex = 0.8,
     vertex.label.dist = 0,
     vertex.label.color = "black",
     edge.color = "grey",
...
title(main = "Figure 4.6: Resident–Supervisor (Bipartite) Network - Nodes' size adjusted based on degree", cex.main = 0.9)
legend("bottomleft",
       c("Male", "Female"),
       pch = c(22, 21),           # 22 = filled square, 21 = filled circle
       col = "black",
...
title(main = "Figure 4.7: Resident–Supervisor (Bipartite) Network Nodes' size adjusted based on Strenght", cex.main = 0.9)
legend("bottomleft",
       c("Male", "Female"),
       pch = c(22, 21),           # 22 = filled square, 21 = filled circle
       col = "black",
...
summ_tbl %>%
  kbl(
    caption = "Resident projection vs Peer network: summary",
    booktabs = TRUE,
    digits = 3,
    align = c("l","r","r","r","r","r"),
...
cmp_tbl %>%
  kbl(
    caption = "Resident projection vs Peer network: overlap and similarity",
    booktabs = TRUE,
    digits = 3,
    align = c("l","r"),
    format.args = list(nsmall = 3)
...
```
```{r peer-qap, echo=FALSE, message=FALSE}
library(sna)
...
# **7) Compare Three bipartite networks**
